package org.lhyf.config.api.controller;
...
public class ConfigController {
    ...
    public Map<String, String> getConfig(@PathVariable("appcode") String appcode,
        ...
        List<Item> list = itemService.selectItemByAppCodeAndEnvNameAndNScode(appcode,envname,nscode);
    ...
    public Map<String, String> getConfig(@PathVariable("appcode") String appcode,
        ...
        List<Item> list = itemService.selectItemByAppCodeAndEnvName(appcode,envname);
        Map<String, String> map = new LinkedHashMap<>();
        for(Item i:list){
            map.put(i.getProperty(),i.getValue());
        }
